...
export default function NewPost() {
  const postFormSchema = z.object({
    ...
    min_age: z.number().min(1).max(100),
    max_age: z.number().min(1).max(100),
    start_date: z.date(),
    end_date: z.date(),
    registration_cutoff: z.date(),
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  <FormLabel>Register by</FormLabel>
                  <Popover>
                    <PopoverTrigger asChild>
                      <FormControl>
                        <Button
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Please enter a contact email for your event.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
